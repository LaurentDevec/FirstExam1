...
import FirstExam1.FitnessChaos.utils.time.DateRange;
...
import java.util.TreeSet;
    ...
    public class SeasonTicket implements Comparable<SeasonTicket> {

        final Client holder;
        final SeasonTicketType type;
        final DateRange pass;
        private boolean isUsed = false;

        public SeasonTicket(Client holder, SeasonTicketType type) {
        ...
        @Override
        public int compareTo(SeasonTicket sub) {
        ...
        enum SeasonTicketType {
            ...
            SeasonTicketType(String description) {
