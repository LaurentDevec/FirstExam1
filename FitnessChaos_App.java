...
import FirstExam1.FitnessChaos.utils.TimeRange;
...
import java.util.Random;
    ...
    public class App {
        ...
        public static void main(String[] args) {
            ClubClubFit club = new ClubClubFit ("Тю-лень",
            ...
            SeasonTicket.SeasonTicketType[] types = SeasonTicket.SeasonTicketType.values();
            for (int i = 0; i < 1000; i++) {
                club.register(getRandomClient(), types[randomInt(types.length)]);
            }
            ArrayList<SeasonTicket> subs = new ArrayList<>(club.getSubscriptions());
        ...
        static Client getRandomClient() {
            ...
            if (randomBoolean()) {
                result = new Client(R_SURNAMES_F[randomInt(R_SURNAMES_F.length)],
