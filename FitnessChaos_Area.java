...
import FirstExam1.FitnessChaos.time.TimeRange;
...
import FirstExam1.FitnessChaos.utils.StringHelper.normalizeCyrillic;
...
public class Area implements Comparable<Area> {
    ...
    private TreeSet<SeasonTicket> visitors = new TreeSet<>();
    ...
    public TreeSet<SeasonTicket> getVisitors() {
        return visitors;
    }

    public void visit(SeasonTicket s) {
        if (hasSlot()) {
            visitors.add(s);
        }
    }
